	...
	xmlhttp.onreadystatechange=function()
	{
		if (xmlhttp.readyState==4 && xmlhttp.status==200)
		{
			...
			for (i=0;i<items.length;i++)
			{
				...
				xml_content += '<div id="title_' + i + '" class="col s10 item_title"><h5 style="font-size:98%"><a href="#a_' + i + '" onclick="read('+ i +')" style="color:#212121;">' + items[i].getElementsByTagName("title")[0].textContent + '</a></h5><br /></div>';
